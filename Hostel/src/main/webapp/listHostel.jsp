		...
		<div class="w3-responsive w3-card-4">
			<table class="w3-table w3-striped w3-bordered">
				...
				<tbody>
					...
					<tr>
            			...
            			<td><a class="w3-button w3-green" href="HostelController?action=view&id=<c:out value="${h.id}"/>">View</a></td>
            			<td><a class="w3-button w3-blue" href="HostelController?action=update&id=<c:out value="${h.id}"/>">Update</a></td>
			...
			<script>
				function confirmation(id){					  		 
		  			...
		  			if (r == true) {				 		  
			  			location.href = 'HostelController?action=delete&id=' + id;
